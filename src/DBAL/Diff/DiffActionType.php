...
enum DiffActionType: string
{
	...
	case UNIQUE_CONSTRAINT_ADDED = 'UNIQUE_CONSTRAINT_ADDED';

	case UNIQUE_CONSTRAINT_DELETED = 'UNIQUE_CONSTRAINT_DELETED';
	...
	public function getPriority(): int
	{
		return match ($this) {
			...
			self::UNIQUE_CONSTRAINT_DELETED      => 12,
			...
			self::UNIQUE_CONSTRAINT_ADDED      => 81,
