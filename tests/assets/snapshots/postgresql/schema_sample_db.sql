...
--
DROP TABLE IF EXISTS "gObL_users" CASCADE;
...
--
DROP TABLE IF EXISTS "gObL_roles" CASCADE;
...
--
DROP TABLE IF EXISTS "gObL_tags" CASCADE;
...
--
DROP TABLE IF EXISTS "gObL_taggables" CASCADE;
...
--
DROP TABLE IF EXISTS "gObL_articles" CASCADE;
