...
`client_data` json NOT NULL DEFAULT ('{}'),
`client_created_at` bigint(20) NOT NULL,
`client_updated_at` bigint(20) NOT NULL,
...
`account_client_id` bigint(20) unsigned NOT NULL,
`account_label` varchar(60) NOT NULL,
`account_balance` decimal unsigned NOT NULL DEFAULT '0',
`account_currency_code` varchar(30) NOT NULL,
`account_data` json NOT NULL DEFAULT ('{}'),
`account_created_at` bigint(20) NOT NULL,
`account_updated_at` bigint(20) NOT NULL,
...
`ccy_data` json NOT NULL DEFAULT ('{}'),
`ccy_created_at` bigint(20) NOT NULL,
`ccy_updated_at` bigint(20) NOT NULL,
`ccy_valid` tinyint(1) NOT NULL DEFAULT '1',
