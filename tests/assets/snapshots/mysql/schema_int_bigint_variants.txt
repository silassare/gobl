...
`t_plain_int` integer(11) NOT NULL,
`t_signed_int` integer(11) NOT NULL DEFAULT '42',
`t_nullable_int` integer(11) NULL DEFAULT NULL,
`t_plain_bigint` bigint(20) NOT NULL,
`t_unsigned_bigint` bigint(20) unsigned NOT NULL,
